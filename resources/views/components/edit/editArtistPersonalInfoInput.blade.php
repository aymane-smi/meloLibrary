<div>
    ...
    <div class="flex flex-col mt-3">
        ...
        <input type="date" target="\d{2}-\d{2}-\d{4}" name="birthday" id="birthday_edit" class="rounded-md mt-2 bg-transparent border-4 p-2 border-[#15181b] outline-none"/>
        <p class="text-[10px] text-red-500" id="birthday_edit_err"></p>
    </div>
    <div class="mt-2">
        ...
        <input type="file" name="artist_image" id="image_edit" class="hidden"/>
